...
export const PLACES = [
  ...
  P('temple-mount', 'Temple Mount (Moriah)', 31.777778, 35.235556, 'secure'),
  ...
  P('shiloh', 'Shiloh', 32.055703, 35.289536, 'secure', { modern: 'Khirbet Seilun' }),
  P('gerizim', 'Mount Gerizim', 32.2000, 35.2733, 'secure'),
  P('ebal', 'Mount Ebal', 32.2333, 35.2833, 'secure'),
  P('gibeon', 'Gibeon', 31.847451, 35.183351, 'secure', { modern: 'el-Jib' }),
  ...
  P('lachish', 'Lachish', 31.565278, 34.849167, 'secure', { modern: 'Tel Lachish' }),
  ...
  P('en-gedi', 'En Gedi', 31.462693, 35.387749, 'secure'),
  P('ziklag', 'Ziklag', 31.4000, 34.7000, 'disputed'),
  P('qumran', 'Qumran', 31.7411, 35.4589, 'secure'),
  P('masada', 'Masada', 31.316363, 35.353714, 'secure'),
  P('bethany', 'Bethany', 31.771661, 35.255903, 'probable', { modern: 'al-Eizariya' }),
  P('olives', 'Mount of Olives', 31.777946, 35.245686, 'secure'),
  ...
  P('nebo', 'Mount Nebo', 31.767417, 35.725134, 'traditional'),
  ...
  P('rabbah', 'Rabbah of the Ammonites', 31.954700, 35.934300, 'secure', { modern: 'Amman, Jordan' }),
  ...
  P('beth-shan', 'Beth Shan', 32.503611, 35.503056, 'secure' ),
  ...
  P('jezreel', 'Jezreel', 32.557853, 35.327953, 'secure'),
  P('gilboa', 'Mount Gilboa', 32.5000, 35.4000, 'secure'),
  P('endor', 'Endor', 32.6300, 35.4200, 'probable'),
  P('megiddo', 'Megiddo', 32.585278, 35.184444, 'secure'),
  P('carmel', 'Mount Carmel', 32.7333, 35.0500, 'secure'),
  P('samaria', 'Samaria', 32.276111, 35.195000, 'secure', { modern: 'Sebastia' }),
  P('sychar', 'Sychar (Jacob’s Well)', 32.2100, 35.2800, 'probable'),
  P('dothan', 'Dothan', 32.4067, 35.1919, 'secure'),
  P('hazor', 'Hazor', 33.018333, 35.569167, 'secure'),
  P('dan', 'Dan', 33.249000, 35.652000, 'secure', { modern: 'Tel Dan' }),
  P('hermon', 'Mount Hermon', 33.4162, 35.8571, 'secure'),
  P('caesarea-philippi', 'Caesarea Philippi', 33.246111, 35.693333, 'secure', { modern: 'Banias' }),
  ...
  P('caesarea', 'Caesarea Maritima', 32.500000, 34.891667, 'secure'),
  P('gaza', 'Gaza', 31.504000, 34.464400, 'secure'),
  ...
  P('gath', 'Gath', 31.699720, 34.846940, 'probable', { modern: 'Tell es-Safi' }),
