...
export const SOURCE_CATALOG = {
  ...
  'ucl-digital-egypt': {
    title: 'UCL Digital Egypt for Universities',
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
  ...
  'jewish-museum': {
    ...
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
    url: 'https://thejewishmuseum.org/',
  },
  'digital-karnak': {
    title: 'Digital Karnak · UCLA',
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
    url: 'https://digitalkarnak.ucsc.edu/',
  },
  'louvre-collections': {
    title: 'Louvre Collections',
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
    url: 'https://collections.louvre.fr/',
  },
  'british-museum': {
    title: 'The British Museum Collection',
    type: 'archaeological-reference',
    license: 'Citation only; object-image rights vary',
    url: 'https://www.britishmuseum.org/collection',
  },
  oracc: {
    title: 'ORACC · Open Richly Annotated Cuneiform Corpus',
    type: 'primary-text',
    license: 'CC BY-SA 3.0 unless an item states otherwise',
    url: 'https://oracc.museum.upenn.edu/',
  },
  'michigan-image-database': {
    title: 'University of Michigan Ancient Near East Image Database',
    type: 'archaeological-reference',
    license: 'Citation only; item rights retained by publisher',
    url: 'https://image-database.nes.lsa.umich.edu/',
  },
  'elephantine-project': {
    title: 'Elephantine — Localizing 4,000 Years of Cultural History',
    type: 'primary-text',
    license: 'CC BY-NC-SA 4.0 unless an item states otherwise',
    url: 'https://elephantine.smb.museum/',
  },
  perseus: {
    title: 'Perseus Digital Library',
    type: 'primary-text',
    license: 'Text reuse terms vary by edition',
    url: 'https://www.perseus.tufts.edu/',
  },
  'israel-museum': {
    title: 'The Israel Museum, Jerusalem',
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
    url: 'https://www.imj.org.il/en',
  },
  'phi-inscriptions': {
    title: 'Searchable Greek Inscriptions · Packard Humanities Institute',
    type: 'primary-text',
    license: 'Citation only; database rights retained by publisher',
    url: 'https://epigraphy.packhum.org/',
  },
  'parco-colosseo': {
    title: 'Parco archeologico del Colosseo',
    type: 'archaeological-reference',
    license: 'Citation only; page rights retained by publisher',
